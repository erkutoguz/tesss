...
int main(int argc, char **argv)
{
	...
	char *encrypted;
	/*
	Block64 *b64_text, *b64_key;
	b64_text = (Block64 *)malloc(sizeof(Block64));
	b64_key = (Block64 *)malloc(sizeof(Block64));

	mempcpy(b64_text->text, text, 8);
	mempcpy(b64_key->text, key, 8);
	*/
...
void run_des(DES * des, char *des) {
	int rd;
	rd = 0;
	char *kl, *kr, *tk, *k48, *r48, *r32, *t32;
	kl = (char *)malloc(28);
	kr = (char *)malloc(28);
	tk = (char *)malloc(56);
	k48 = (char *)malloc(48);
